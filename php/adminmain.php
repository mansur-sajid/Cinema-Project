          ...
          <div class="container-fluid">
            ...
            <div class="nav-links">
              <ul>
                ...
                <li><a href="../main_page.php">Log out</a></li>
              </ul>
            </div>
          </div>
        </nav>
    ...
    <span class="visually-hidden">Next</span>
        ...
        <div class="autoplay offset-lg-2 col-lg-8 mt-5 mb-5">
          ...
          if (mysqli_num_rows($res) > 0) {
              ...
              echo "<div class='movie'><form action='show.php' method='post'>
                  <div class='card col-10'>
                    <div class='book col-12 text-center'><button type='submit'>BOOK NOW</button></div>
                    <img src ='uploads/".$row['image_url']."' class='card-img-top'>
                    <div class='card-body'>
          ...
          ?>
        <div style="margin-top:50px;" id="contact">
           <?php
